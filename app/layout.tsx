...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div className="colored-balls bg-[#8befef] absolute top-[-6rem] blur-[10rem] -z-10 right-[11rem] 
        h-[31.25rem] w-[31.25rem] rounded-full sm:w-[68.75rem]
         dark:bg-[#629394]"></div>
        <div className="colored-balls bg-[#87b7ee] absolute top-[-1rem] blur-[10rem] -z-10 left-[-35rem]
         h-[31.25rem] w-[50rem] rounded-full  sm:w-[68.75rem]
          md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem]
           dark:bg-[#4074a7]"></div>

{/* <div className="colored-balls bg-[#8befef] absolute top-[-6rem] blur-[10rem] -z-10 right-[11rem] 
        h-[31.25rem] w-[31.25rem] rounded-full sm:w-[68.75rem] xl:right-[-5rem] 2xl:right-[1rem]
         dark:bg-[#629394]"></div>
        <div className="colored-balls bg-[#87b7ee] absolute top-[-1rem] blur-[10rem] -z-10 left-[-35rem]
         h-[31.25rem] w-[50rem] rounded-full  sm:w-[68.75rem]
          md:left-[-33rem] lg:left-[-28rem] xl:left-[-25rem] 2xl:left-[11rem]
           dark:bg-[#4074a7]"></div> */}
